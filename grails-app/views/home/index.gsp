...
<head>
    ...
    $(document).ready(function() {
        $('.dropdown').hover(
            function() {
                $(this).children('dropdown-menu').slideDown(5000);
            },
            function() {
                $(this).children('dropdown-menu').slideUp(5000);
            }
        );
    });
...
<body>
    ...
    <div class="container text-center">
        <h1 style="font-size:55px">Lenn Pabs</h1>
        <h3>A new generation of Penn Labs.</h3>
        <div class="pennlabs-logo">
            <g:img dir="images" file="pennlabs.png" align="center" style="margin:auto;position:relative;" />
        </div>
    </div>
</body>
